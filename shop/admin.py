...
from .models import Item, Article, Category, Order, Review
...
class ItemAdmin(admin.ModelAdmin):
    ...
    list_display = ('title', 'text', 'get_article', 'get_reviews_count', 'category')
...
class ReviewAdmin(admin.ModelAdmin):
    list_display = ('name', 'get_review_starts', 'item')

    def get_review_starts(self, obj):
        return obj.star * '★'

    get_review_starts.short_description = 'Оценка'
